...
本文档介绍如何在本地搭建 CodeHubot 平台的开发环境，包括前端、后端、数据库等各个模块的配置。
...
前端使用 Vite，配置文件在 `vite.config.js`：
...
**推荐工具**:
- **TablePlus**: 现代化 GUI 工具（macOS/Windows/Linux）
- **DBeaver**: 免费开源（跨平台）
...
创建初始化脚本 `scripts/init_dev_db.sh`:
...
- [调试技巧](./调试技巧.md) - 学习调试方法
- [API测试](./API测试.md) - 接口测试工具和方法
- [常见问题排查](./常见问题排查.md) - 问题诊断指南

## 相关文档

- [整体架构设计](../02_系统架构/整体架构设计.md) - 了解系统架构
- [Docker容器化部署](../03_部署运维/Docker容器化部署.md) - Docker 部署方案
- [API开发规范](../../docs_开发规范/01_API开发规范.md) - API 开发规范
