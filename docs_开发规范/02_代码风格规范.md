...
from app.core.response import success_response
from app.models.pbl import PBLCourse
from app.schemas.pbl import CourseCreate, CourseUpdate
...
# 辅助函数（私有）
def _check_course_permission(course_id: int, user_id: int, db: Session) -> PBLCourse:
    """检查课程权限"""
...
import { getCourses, createCourse } from '@/modules/pbl/api/courses'
